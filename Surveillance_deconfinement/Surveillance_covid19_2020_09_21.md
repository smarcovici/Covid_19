...
**Paris, les Yvelines, la Seine-saint-Denis, les Hauts de Seine et la Haute-Garonne** ont  une hausse progressive mais légère des hospitalisations qui ne justifie pas actuellement de mesures trop restrictives (limitation interactions sociales, confinement local) mais plus une amélioration de l'efficacité des mesures en cours (tests de dépistage et gestes barrières).
